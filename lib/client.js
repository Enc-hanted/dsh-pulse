window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function BucketChart({ buckets, granularity, today, modelBuckets, accentMap, byModel, names, onDrillHourly, t }) {
			...
			useEffect(() => { setDrillIdx(null); setHoverSeg(null); }, [buckets, byModel]);
			...
			if (drillIdx !== null && rows[drillIdx] !== undefined) {
				...
				const drillStyle = seed !== null
					...
					: undefined;
				const subSeg = hoverSeg !== null ? segs.find((seg) => seg.key === hoverSeg) ?? null : null;
			...
			return jsx("div", { ref: outerRef, className: "dp_chartOuter", children: jsxs("div", { className: "dp_chartGrid", children: [
				...
				panels.trend !== false && jsxs("div", { children: [
					...
					jsx("div", { className: "dp_trendBody", children: hourly
						...
						: heatmap
							...
							: jsxs("div", { children: [
								jsx(BucketChart, { buckets: view.buckets, granularity: "day", today: data.today, modelBuckets: view.modelBuckets, accentMap, byModel, names, onDrillHourly: () => setRangeKey("1"), t }),
								jsx(BucketXLabels, { buckets: view.buckets, granularity: "day", today: data.today, t }),
								byModel
									? jsxs("div", { className: "dp_legend", children: [
										modelLegendRows.map((row) => jsxs("span", { children: [
