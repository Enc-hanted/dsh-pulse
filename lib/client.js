window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function Toolbar({ rangeKey, setRangeKey, custom, setCustom, project, setProject, knownProjects, model, setModel, knownModels, names, t }) {
		...
		function PulseDashboard({ t, headerExtra, onConfigure, floatActions = false }) {
			...
			if (data === null || stats.status === "loading" || staleWindow) {
				return jsxs("div", { className: "dp_root", "data-dp-theme": theme, children: [
					...
					view !== null
						? jsx(Toolbar, { rangeKey, setRangeKey, custom, setCustom, project, setProject, knownProjects: view.knownProjects, model, setModel, knownModels: view.knownModels, names, t })
		...
		function PulseOverlay({ t }) {
			...
			return jsx("div", {
				...
				children: jsx("div", { className: "dp_overlayCard", role: "dialog", "aria-label": t("title"), children: [
					jsx("div", { className: "dp_overlayScroll", children: jsx(PulseDashboard, { t, floatActions: true }) }),
