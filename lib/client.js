		...
		function BalanceChip({ balance, series, active = false, onToggle, t }) {
			...
			return jsxs("div", {
				...
				jsxs("div", { className: "dp_sparkHead", children: [
					...
					clickable && jsx("span", { className: "dp_sparkChevron", "aria-hidden": true, children: "▾" }),
				] }),
				ok ? [
				...
				panels.trend !== false && jsxs("div", { ref: swapRef, className: focusOn ? "dp_focusKeep" : undefined, children: [
					jsxs("div", { key: swapView, className: "dp_swapIn", children: [
						jsxs("div", { className: `dp_panelTitle${swapView === "cost" || (swapView === "use" && !hourly && !heatmap && hasModelSplit) ? " dp_hasStack" : ""}`, children: [
							...
							swapView !== "use" && jsx("button", {
								type: "button", className: "dp_iconBtn", onClick: exitFocusAll,
								title: t("backToUsage"), "aria-label": t("backToUsage"),
								style: swapView === "cost" ? undefined : { marginLeft: "auto" },
								children: jsx("svg", { width: 15, height: 15, viewBox: "0 0 16 16", fill: "none", "aria-hidden": true, children: jsx("path", { d: "M4 4l8 8M12 4l-8 8", stroke: "currentColor", strokeWidth: 1.4, strokeLinecap: "round" }) }),
							}),
						] }),
