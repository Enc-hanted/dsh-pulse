window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function CostTrendPanel({ costs, today, actualByDay, accentMap, byModel, names, t }) {
			const [hover, setHover] = useState(null);
			const [drillIdx, setDrillIdx] = useState(null);
			const [seed, setSeed] = useState(null);
			const outerRef = useRef(null);
			const rows = Array.isArray(costs) ? costs : [];
			useEffect(() => setDrillIdx(null), [costs, byModel]);
			useEffect(() => {
				if (drillIdx === null || seed === null) return undefined;
				const frame = requestAnimationFrame(() => setSeed(null));
				return () => cancelAnimationFrame(frame);
			...
			useEffect(() => {
				if (drillIdx === null) return undefined;
				const onKey = (e) => { if (e.key === "Escape") setDrillIdx(null); };
				window.addEventListener("keydown", onKey);
				return () => window.removeEventListener("keydown", onKey);
			}, [drillIdx]);
			...
			if (drillIdx !== null && rows[drillIdx] !== undefined) {
				...
				return jsxs("div", { className: "dp_drill", onClick: () => setDrillIdx(null), children: [
					jsxs("div", { className: "dp_drillHead", children: [
						jsx("button", { type: "button", className: "dp_setLink", onClick: () => setDrillIdx(null), children: `← ${t("backToDays")}` }),
						jsxs("span", { className: "dp_drillTotal", children: [
			...
			return jsxs("div", { children: [
				jsx("div", { ref: outerRef, className: "dp_chartOuter", children: jsxs("div", { className: "dp_chartGrid", children: [
					...
					rows.map((row, i) => {
						...
						return jsx("div", {
							className: `dp_col${isOffPeakDay(row.key) ? " dp_colOff" : ""}`,
							onMouseEnter: () => setHover(i),
							onMouseLeave: () => setHover(null),
							onClick: (e) => enterDrill(i, e),
							children: [
			...
			return jsxs("div", { className: "dp_root", "data-dp-theme": theme, children: [
				...
				showChips && jsxs("div", { className: "dp_chips", children: [
					...
					panels.cost !== false && costEnabled && cost.configured === true && costDays !== null
						...
						&& jsx(CostSpark, { days: costDays, actual: thirdParty ? null : (Array.isArray(data?.balanceSeries) ? data.balanceSeries : null), t }),
				...
				panels.trend !== false && jsxs("div", { children: [
					jsxs("div", { className: `dp_panelTitle${!hourly && !heatmap && hasModelSplit ? " dp_hasStack" : ""}`, children: [
					...
					jsx("div", { className: "dp_trendBody", children: hourly
						...
						: heatmap
							...
							: jsxs("div", { children: [
								...
								!trendDrilled && jsx(BucketXLabels, { buckets: view.buckets, granularity: "day", today: data.today, t }),
							] }) }),
				] }),
				panels.costTrend !== false && costEnabled && !hideCostish && !hourly && view !== null && view.cost.configured === true && jsxs("div", { children: [
					jsxs("div", { className: "dp_panelTitle dp_hasStack", children: [
						jsx("span", { children: t("costTrend") }),
						jsx("span", { className: "dp_panelCount", children: fill(t("dailyCount"), { n: bucketCount }) }),
						jsxs("div", { className: "dp_seg dp_stackToggle", children: [
