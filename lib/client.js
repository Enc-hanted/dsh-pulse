window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function CacheRing({ totals, active = false, onToggle, t }) {
		...
		function PulseDashboard({ t, headerExtra, onConfigure, floatActions = false, renderSlot: renderPanelsSlot, actions }) {
			...
			return jsxs("div", { className: "dp_root", "data-dp-theme": theme, children: [
				...
				showChips && jsxs("div", { className: "dp_chips", children: [
					panels.cache !== false && jsx(CacheRing, {
						totals,
						active: swapView === "use",
