	...
	factory: (require) => {
		...
		function BucketChart({ buckets, granularity, today, modelBuckets, accentMap, byModel, names, legendRows, onDrillChange, onDrillHourly, t }) {
			...
			if (drillIdx !== null && rows[drillIdx] !== undefined) {
				...
				const subPct = (v) => (subSum > 0 ? Math.round((v / subSum) * 100) : 0);
				...
				return jsxs("div", { className: "dp_drill", onClick: exitDrill, children: [
					...
					jsxs("div", { className: "dp_drillBarWrap", children: [
						...
						byModel && subSeg !== null && jsxs("div", { className: "dp_drillSub", children: [
							jsx("div", { className: "dp_drillSubNote", children: `${subLabel} · ${t("legendInput")} ${subPct(subIn)}% · ${t("legendCache")} ${subPct(subCache)}% · ${t("legendOutput")} ${subPct(subOut)}%` }),
							jsxs("div", { className: "dp_drillSubBar", children: [
								jsx("div", { className: "dp_drillSubSeg", style: { width: `${subPct(subIn)}%`, background: "var(--dsw-alias-state-business-primary)" } }),
								jsx("div", { className: "dp_drillSubSeg", style: { width: `${subPct(subCache)}%`, background: "color-mix(in srgb,var(--dsw-alias-state-business-primary) 60%,var(--dsw-alias-state-business-tertiary))" } }),
								jsx("div", { className: "dp_drillSubSeg", style: { width: `${subPct(subOut)}%`, background: "var(--dsw-alias-state-success-primary)" } }),
							] }),
						] }),
